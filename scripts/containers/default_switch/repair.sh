...
sudo ifconfig eth1 10.128.41.3 netmask 255.255.0.0
sudo ifconfig eth2 10.127.41.3 netmask 255.255.0.0
sudo ifconfig eth3 10.126.41.3 netmask 255.255.0.0
